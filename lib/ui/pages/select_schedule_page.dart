...
class _SelectSchedulePageState extends State<SelectSchedulePage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        context.bloc<PageBloc>().add(GoToMovieDetailPage(movieDetail));
        return;
      },
      child: Scaffold(
        body: Stack(
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          context
                              .bloc<PageBloc>()
                              .add(GoToMovieDetailPage(movieDetail));
                        },
                        child: Icon(
                          Icons.arrow_back,
                          color: Colors.black,
                  ...
                  child: BlocBuilder<UserBloc, UserState>(
                    builder: (context, state) {
                      return FloatingActionButton(
                        backgroundColor: (isValid) ? mainColor : disabledColor,
                        child: Icon(
                          Icons.arrow_forward,
                          color: isValid ? Colors.white : iconDisabledColor,
                        ),
                        onPressed: () {
                          if (isValid) {
